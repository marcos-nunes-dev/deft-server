...
mng.register = async (object) => {
  ...
  if (object._id){
    ...
    console.log(chalk.redBright('[LEGACY] ')+'ManagerError: object could not be registered in '+collection+', missing id.');
  }
}
...
mng.save = async (object) => {
  ...
  if (object._id){
    ...
    console.log(chalk.redBright('[LEGACY] ')+'ManagerError: object could not be saved in '+collection+', missing id.');
  }
}
...
mng.remove = async (object) => {
  ...
  if (object._id){
    ...
    console.log(chalk.redBright('[LEGACY] ')+'ManagerError: object could not be removed in '+collection+', missing id.');
  }
}
